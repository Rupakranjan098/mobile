...
const styles = StyleSheet.create({
  ...
  quickActions: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 28, paddingHorizontal: 4 },
  actionCard: { width: (SCREEN_WIDTH - 64) / 5.2, height: 72, borderRadius: 16, justifyContent: 'center', alignItems: 'center', gap: 4, overflow: 'hidden', borderWidth: 1 },
  actionGradient: { ...StyleSheet.absoluteFillObject },
  actionLabel: { fontSize: 9, fontWeight: '800', letterSpacing: 0.2 },
