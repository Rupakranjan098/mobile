...
const RegisterScreen = ({ onRegisterSuccess, onSwitchToLogin }) => {
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={[styles.decorCircle, { top: -50, left: -50, backgroundColor: 'rgba(34, 197, 94, 0.1)' }]} />
      <View style={[styles.decorCircle, { bottom: -100, right: -100, backgroundColor: 'rgba(30, 64, 175, 0.1)' }]} />
